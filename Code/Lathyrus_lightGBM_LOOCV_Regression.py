# -*- coding: utf-8 -*-
"""
Created on Monday 4 March 2025
...
input_filename = 'Lathyrus_Data.xlsx'
output_filename = 'output_lightGBM_Lathyrus_Data(CAR).txt'
...
data_orj['Species'] = data_orj['Species'].astype('category')
data_orj['Year'] = data_orj['Year'].astype('category')
